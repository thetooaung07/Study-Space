...
\textbf{Google Gemini API (gemini-3-flash-preview)} provides a large context window, competitive
...
\texttt{gemini-3-flash-preview} model's context window comfortably accommodates the semantically relevant chunks
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ui/student_sessions_view.png}
    \caption{Study sessions view: Managing active and scheduled collaborative sessions}
    \label{fig:student-sessions}
\end{figure}
