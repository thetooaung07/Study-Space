...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/1_user_domain_model.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/2_course_admin_domain_model.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3_content_extension_model.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/4_contextual_message_domain_model.png}
...
For local development, all three tiers can be orchestrated using \texttt{docker-compose.yml}
